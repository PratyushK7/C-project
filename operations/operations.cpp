...
//void crudOperations::saveToFile()
//{
//    fstream file;
//    file.open("bookFile.csv",ios::out | ios::app);
...
//        {
//
//            if(std::find(v.begin(),v.end(),(*j).bookId)!=v.end())
//            {
//
...
//    file.close();
//}
//void crudOperations::retrieveFromFile()
//{
...
//        }
//
//        cout<<"Book category: "<<row[0]<<"\n";
//        cout<<"Book Id: "<<row[1]<<"\n";
//        cout<<"Book Name: "<<row[2]<<"\n";
//        cout<<"Book cost: "<<row[3]<<"\n";
//        cout<<"Book author: "<<row[4]<<"\n";
//        cout<<"Book publisher: "<<row[5]<<"\n";
//        cout<<"Book stock: "<<row[6]<<"\n";
//        cout<<"-----------------------\n";
//    }
//
//    fin.close();
